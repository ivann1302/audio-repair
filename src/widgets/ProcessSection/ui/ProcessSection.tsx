...
const steps = [
  ...
  },
  {
    ...
    title: 'ДИАГНОСТИКА',
    description:
      'Бесплатная диагностика. Через 1 день вы получите точный диагноз и фиксированную стоимость ремонта.',
  },
  {
    id: '3',
    title: 'РЕМОНТ\nИ ВЫДАЧА',
    description:
      'Ремонтирую в срок. Даю гарантию 6 месяцев на все виды работ. Доставка по городу.',
  },
]
